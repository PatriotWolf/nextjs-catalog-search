...
function (_React$Component) {
  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      var categories = []; // let categories = result.map(x=>{
      //     let {category} = x;
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Div, {
        ...
        return name && category && categories.indexOf(category) && (name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase())) && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Tag, {
...
//# sourceMappingURL=index.js.66c3e72d7f7c46ee711f.hot-update.js.map