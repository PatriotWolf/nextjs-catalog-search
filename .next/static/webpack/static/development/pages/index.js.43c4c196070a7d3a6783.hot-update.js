  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      var card = result.map(function (x) {
        var name = x.name,
            category = x.category;
        var cond1 = name && category && (name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase()));
        console.log(cond1);
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Div, {
        ...
        var name = x.name,
            ...
            category = x.category;
        return name && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Tag, {
          onClick: function onClick() {
            return _this2.handleClickTag(name);
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 140
...
//# sourceMappingURL=index.js.43c4c196070a7d3a6783.hot-update.js.map