    ...
    value: function render() {
      ...
      var card = result.map(function (x) {
        var name = x.name,
            category = x.category;
        cond1 = name && category;
        cond2 = name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase());
...
//# sourceMappingURL=index.js.f3b1b0e0d78b7d40e754.hot-update.js.map