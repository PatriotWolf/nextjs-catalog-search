...
function (_React$Component) {
  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      var categories = result.map(function (x) {
        if (!categories.indexOf(category)) {
          recategories.push(category);
        }
      });
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Div, {
        ...
        var name = x.name,
            category = x.category; // if (!categories.indexOf(category)){
...
//# sourceMappingURL=index.js.4d7fa756176dff74bd83.hot-update.js.map