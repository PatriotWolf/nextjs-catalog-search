  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      var card = result.map(function (x) {
        ...
        if (name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase())) {
          return x;
        }
      });
      console.log(unique);
...
//# sourceMappingURL=index.js.b23d01b31cab44850044.hot-update.js.map