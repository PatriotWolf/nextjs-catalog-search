  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      categories = result.filter(function (x) {
        var name = x.name,
            category = x.category;
        if (name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase())) return x;
      });
...
//# sourceMappingURL=index.js.fba5081ba799def989ce.hot-update.js.map