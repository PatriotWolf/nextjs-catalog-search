...
function (_React$Component) {
  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      card = result.map(function (x) {
        var name = x.name,
            image_link = x.image_link,
            category = x.category;
        return name && category && (name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase())) && x;
      });
      console.log(unique);
...
//# sourceMappingURL=index.js.f57358c40dc25f65ecd1.hot-update.js.map