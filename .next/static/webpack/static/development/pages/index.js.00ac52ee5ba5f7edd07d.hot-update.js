  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      var card = result.map(function (x) {
        var name = x.name,
            category = x.category;
        var cond1 = name && category;
        var cond2 = name.toLowerCase().includes(value.toLocaleLowerCase()) || category.toLowerCase().includes(value.toLocaleLowerCase());
...
//# sourceMappingURL=index.js.00ac52ee5ba5f7edd07d.hot-update.js.map